...
export default function InvoiceDetailsCard({ invoice, refreshInvoices }: InvoiceProps) {
  ...
  return (
    <>
      {openDeleteConfirmation && <DeleteConfirmation close={closeDeleteConfirmation} confirmFunction={deleteInvoice} />}

      <div className="containerDetails" key={invoice.id}>
        <div className="invoiceDetails">
          <FaTrash className="deleteInvoice" onClick={() => setOpenDeleteConfirmation(true)} />
